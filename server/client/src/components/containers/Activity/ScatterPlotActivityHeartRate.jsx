...
import ActivityAndHeartRateRegressionFormula from './ActivityAndHeartRateRegressionFormula'

function sortNumber(a, b) {
  return a - b
}

export default class ScatterPlotActivityHeartRate extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    return (
      ...
      <h2 className="ind-page-title">Linear Regression of Calories Burned vs. Resting Heart Rate</h2>
        <svg 
          viewBox="0 0 960 500"
        ...
        <ActivityAndHeartRateRegressionFormula />
      </div>
    )
  }
}
